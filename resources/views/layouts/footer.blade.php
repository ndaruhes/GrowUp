<div class="footer mt-5">
    <svg class="wave-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 170.7 1440 149.3">
        <path fill="#F8F9FA" fill-opacity="1" d="M0,256L48,245.3C96,235,192,213,288,213.3C384,213,480,235,576,224C672,213,768,171,864,170.7C960,171,1056,213,1152,229.3C1248,245,1344,235,1392,229.3L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z">
        </path>
    </svg>
    <div class="footer-container">
        <div class="container">
            <footer>
                ...
                <div class="d-flex justify-content-between py-4 mt-4 border-top footer-end">
